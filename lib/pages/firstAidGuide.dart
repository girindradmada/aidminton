...
import 'package:aidminton/models/firstAid.dart';
import 'package:aidminton/pages/templateFirstAid.dart';
...
class _FirstAidGuideState extends State<FirstAidGuide> {
  ...
  void _getInitialInfo() {
    getAidModel = FirstAidModel.getAidModel();
  }
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: 
                        (context) => TemplateFirstAid(whichPage: gotoPage,),
                      )
                    );
                  },
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Image.asset(
                          getAidModel[index].aidPhoto,
                          width: 80,
                          height: 80,
                        ),
                        SizedBox(height: 8),
                        Text(
                          getAidModel[index].aidName,
                          style: TextStyle(
